...
// Caminho do arquivo interno do Expo que está quebrando no Node 24
const arquivo = path.join(__dirname, 'node_modules', 'expo-sqlite', 'build', 'index.js');

if (fs.existsSync(arquivo)) {
  let conteudo = fs.readFileSync(arquivo, 'utf8');
  
  // Se encontrar a importação sem extensão, injeta o .js nela
  if (conteudo.includes("./SQLiteDatabase") && !conteudo.includes("./SQLiteDatabase.js")) {
    ...
    console.log(" Bug de importação do expo-sqlite corrigido com sucesso para o Node 24!");
  }
}